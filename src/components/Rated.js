...
const Rated = (props) => {
    ...
    return (
        <main className="pb-2">
            ...
            <hr />
            <section>
                {(movieData.length > 0) ? <DisplayMovies movieData={movieData} /> : <h4 className="text-center">Sorry you have no rated movies. Search for a movie to add to your favourites.</h4>}
            </section>
        </main>
    );
}
